package com.thekim12.blog.controller.api;
...
public class BoardApiController {
	...
	// dto 사용하지 않는 이유는!! 프로젝트가 작기 때문
	@PostMapping("/api/board/{boardId}/reply")
	public ResponseDto<Integer> replySave(@RequestBody ReplySaveRequestDto replySaverRequestDto){
		boardService.댓글쓰기(replySaverRequestDto);
		return new ResponseDto<Integer>(HttpStatus.OK.value(),1);
	}
